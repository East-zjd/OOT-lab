...
public final class WorkspaceService implements Workspace {
    ...
    private final EditorLabelFormatter editorLabelFormatter;
    ...
    public WorkspaceService(FileSystem fileSystem,
        ...
        this.editorLabelFormatter = new DurationEditorLabelDecorator(new DefaultEditorLabelFormatter(), statistics);
    ...
    private String listEditorsFlat() {
        ...
        for (var entry : openEditors.entrySet()) {
            Path p = entry.getKey();
            Editor ed = entry.getValue();
            sb.append(editorLabelFormatter.format(p, ed, p.equals(active)));
            sb.append('\n');
        }
    ...
    private String formatTreeFile(Path p, Editor ed) {
        return editorLabelFormatter.format(p, ed, p.equals(active));
    }
